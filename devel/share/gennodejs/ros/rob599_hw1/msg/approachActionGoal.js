...
let approachGoal = require('./approachGoal.js');
let std_msgs = _finder('std_msgs');
let actionlib_msgs = _finder('actionlib_msgs');

//-----------------------------------------------------------

class approachActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = approachGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new approachActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = approachGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new approachGoal()
    }
...
module.exports = approachActionGoal;
