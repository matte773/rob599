...
(cl:defmethod cl:initialize-instance :after ((m <FibonacciResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FibonacciResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rob599_basic-msg:<FibonacciResult> is deprecated: use rob599_basic-msg:FibonacciResult instead.")))

(cl:ensure-generic-function 'sequence-val :lambda-list '(m))
(cl:defmethod sequence-val ((m <FibonacciResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rob599_basic-msg:sequence-val is deprecated.  Use rob599_basic-msg:sequence instead.")
  (sequence m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<FibonacciResult>)))
  ...
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# result~%int64[] sequence~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'FibonacciResult)))
  "Returns full string definition for message of type 'FibonacciResult"
  (cl:format cl:nil "# ====== DO NOT MODIFY! AUTOGENERATED FROM AN ACTION DEFINITION ======~%# result~%int64[] sequence~%~%~%"))
